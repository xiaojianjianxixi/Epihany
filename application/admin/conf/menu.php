...
return	array(	
	...
	'shop'=>array('name'=>'商城','child'=>array(
			...
			array('name' => '营销','child' => array(
					...
					array('name' => '积分管理', 'act'=>'points_goods_list', 'op'=>'Pointstion'),
...
*/	     
	...
	'resource'=>array('name'=>'插件','child'=>array(
			array('name' => '插件库','child' => array(
				array('name' => '常用插件', 'act'=>'index', 'op'=>'Plugin'),
				//array('name' => '数据备份', 'act'=>'index', 'op'=>'Tools'),
				//array('name' => '数据还原', 'act'=>'restore', 'op'=>'Tools'),
			)),
	)),
