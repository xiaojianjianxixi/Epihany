...
class Cart extends Base {
    ...
    {        
        ...
        $sql = "select c1.name,c1.money,c1.condition, c2.* from __PREFIX__coupon as c1 inner join __PREFIX__coupon_list as c2  on c2.cid = c1.id and c1.type in(0,1,2,3,5) and order_id = 0  where c2.uid = :user_id  and ".time()." < c1.use_end_time and c1.condition <= :total_fee";
