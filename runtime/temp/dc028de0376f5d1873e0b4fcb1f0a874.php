<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:42:"./application/admin/view2/admin/login.html";i:1526952342;}*/ ?>
<!doctype html>
...
<body>
        ...
        <form action="" name='theForm' id="theForm" method="post">
            <div class="login-form" style="position: relative">
                <div class="formContent">
                	<div class="title">厦门花园便利店管理中心</div>
                    <div class="formInfo">
                    	<div class="formText">
    ...
    <script type="text/javascript">
        ...
        $('.login-layout').keypress(function(event){  
